	...
	<xsl:template match="csw:SearchResults">
		...
		<xsl:choose>
			<xsl:otherwise>
				...
				<xsl:for-each select="wrs:ExtrinsicObject[@objectType='urn:ogc:def:ebRIM-ObjectType:OGC-I15::DataMetadata']">
					<xsl:choose>
				...
				<xsl:for-each select="wrs:ExtrinsicObject[@objectType='urn:ogc:def:ebRIM-ObjectType:OGC-I15::DatasetCollection']">
					<xsl:choose>
						<xsl:when test="../../../csw:GetRecordsResponse">
							<xsl:call-template name="serviceNs:portalMetadataSummary4wrs">
								<xsl:with-param name="self" select="." />
				...
				<xsl:for-each select="wrs:ExtrinsicObject[@objectType='urn:ogc:def:ebRIM-ObjectType:OGC-I15::ServiceMetadata']">
					<xsl:choose>
						<xsl:when test="../../../csw:GetRecordsResponse">
							<xsl:call-template name="serviceNs:portalMetadataSummary4wrs">
								<xsl:with-param name="self" select="." />
				...
				<xsl:for-each select="rim:ExtrinsicObject[@objectType='urn:ogc:def:ebRIM-ObjectType:OGC-I15::DataMetadata']">
					<xsl:choose>
						<xsl:when test="../../../csw:GetRecordsResponse">
							<xsl:call-template name="serviceNs:portalMetadataSummary4rim">
								<xsl:with-param name="self" select="." />
				...
				<xsl:for-each select="rim:ExtrinsicObject[@objectType='urn:ogc:def:ebRIM-ObjectType:OGC-I15::DatasetCollection']">
					<xsl:choose>
						<xsl:when test="../../../csw:GetRecordsResponse">
							<xsl:call-template name="serviceNs:portalMetadataSummary4rim">
								<xsl:with-param name="self" select="." />
				...
				<xsl:for-each select="rim:ExtrinsicObject[@objectType='urn:ogc:def:ebRIM-ObjectType:OGC-I15::ServiceMetadata']">
					<xsl:choose>
						<xsl:when test="../../../csw:GetRecordsResponse">
							<xsl:call-template name="serviceNs:portalMetadataSummary4rim">
								<xsl:with-param name="self" select="." />
			...
			<gmlFeature>
				<gml:featureMember xmlns:gml="http://www.opengis.net/gml">
					<Feature xmlns="http://www.esa.int/xml/schemas/mass/serviceresult">
						...
						<xsl:if test="rim:Slot[@name='urn:ogc:def:ebRIM-slot:OGC-I15::Envelope']/wrs:ValueList/wrs:AnyValue[1]/gml:Envelope">
							<xsl:variable name="a"
								select="substring-before(rim:Slot[@name='urn:ogc:def:ebRIM-slot:OGC-I15::Envelope']/wrs:ValueList/wrs:AnyValue[1]/gml:Envelope/gml:lowerCorner, ' ')" />
							<xsl:variable name="b"
								select="substring-after(rim:Slot[@name='urn:ogc:def:ebRIM-slot:OGC-I15::Envelope']/wrs:ValueList/wrs:AnyValue[1]/gml:Envelope/gml:lowerCorner, ' ')" />
							<xsl:variable name="c"
								select="substring-before(rim:Slot[@name='urn:ogc:def:ebRIM-slot:OGC-I15::Envelope']/wrs:ValueList/wrs:AnyValue[1]/gml:Envelope/gml:upperCorner, ' ')" />
							<xsl:variable name="d"
								select="substring-after(rim:Slot[@name='urn:ogc:def:ebRIM-slot:OGC-I15::Envelope']/wrs:ValueList/wrs:AnyValue[1]/gml:Envelope/gml:upperCorner, ' ')" />
			...
			<gmlFeature>
				<gml:featureMember xmlns:gml="http://www.opengis.net/gml">
					<Feature xmlns="http://www.esa.int/xml/schemas/mass/serviceresult">
						...
						<xsl:if
							test="rim:Slot[@name='urn:ogc:def:ebRIM-slot:OGC-I15::Envelope']/wrs:ValueList/wrs:AnyValue[1]/gml:Envelope">
							<xsl:variable name="a"
								select="substring-before(rim:Slot[@name='urn:ogc:def:ebRIM-slot:OGC-I15::Envelope']/wrs:ValueList/wrs:AnyValue[1]/gml:Envelope/gml:lowerCorner, ' ')" />
							<xsl:variable name="b"
								select="substring-after(rim:Slot[@name='urn:ogc:def:ebRIM-slot:OGC-I15::Envelope']/wrs:ValueList/wrs:AnyValue[1]/gml:Envelope/gml:lowerCorner, ' ')" />
						...
						<xsl:if
							test="rim:Slot[@name='urn:ogc:def:ebRIM-slot:OGC-I15::Envelope']/wrs:ValueList/wrs:AnyValue[1]/gml:Polygon">
							<geometry>
								<xsl:copy-of
									select="rim:Slot[@name='urn:ogc:def:ebRIM-slot:OGC-I15::Envelope']/wrs:ValueList/wrs:AnyValue[1]/gml:Polygon" />
							</geometry>
						</xsl:if>
					</Feature>
				</gml:featureMember>
		...
		<element>
			...
			<xsl:if test="./gmd:distributionInfo">
				<xsl:for-each
					...
					<xsl:if
						test="./gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource/gmd:linkage/gmd:URL != ''">
						<group name="TransferOptions">
			...
			<xsl:if test="sensorML:member/sensorML:System">
				...
				<xsl:if test="sensorML:member/sensorML:System/sensorML:keywords/sensorML:KeywordList/sensorML:keyword != ''">
					<xsl:for-each select="sensorML:member/sensorML:System/sensorML:keywords/sensorML:KeywordList/sensorML:keyword">
						<group name="KeywordGroup">	
							<xsl:choose>
