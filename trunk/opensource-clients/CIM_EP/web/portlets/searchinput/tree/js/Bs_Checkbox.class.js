...
/*
      ...
      out[outI++] = '<input value="' + this.value + '" type=checkbox name="' + "collectionId" + '" id="' + this.checkboxName + '" style="display:none; visibility:hidden;"';
      if (this.value)
        out[outI++] = ' checked';
      out[outI++] = '>';
*/
if (this.checkboxValue) {
  out[outI++] = '<input value="' + this.checkboxValue + '" type=checkbox name="' + "collectionId" + '" id="' + this.checkboxName + '" style="display:none; visibility:hidden;"';
  if (this.value)
    out[outI++] = ' checked';
  out[outI++] = '>';
}
//...rse
  ...
  this.setTo =
    function(value, cancelEventOnChange) {
      this.value = value;
      this._updateHiddenField();
      this._updateIcon();
