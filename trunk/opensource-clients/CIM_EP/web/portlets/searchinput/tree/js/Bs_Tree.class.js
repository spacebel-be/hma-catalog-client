...
this.showPseudoElement = false;
  ...
  this.checkboxSystemImgDir;this.checkboxSystemGuiNochange;
  ...
  this.removeElement = function(elementId) {
    if (typeof(this._clearingHouse[elementId]) == 'undefined')
      return false;
  ...
  this.elementOpenWalkUp = function(id) {
    if (typeof(this._clearingHouse[id]) != 'undefined') {
      ...
      if (typeof(elm.parent) != 'undefined')
        this.elementOpenWalkUp(elm.parent.id);
    }
    else {
      return false;
    }
  ...
  this.elementCloseWalkUp = function(id) {
    if (typeof(this._clearingHouse[id]) != 'undefined') {
      ...
      elm.close(true);
      if (typeof(elm.parent) != 'undefined')
        this.elementCloseWalkUp(elm.parent.id);
    }
    else {
      return false;
    }
  ...
  this.drawInto = function(id) {
    ...
    setTimeout('Bs_Objects['+this._id+']._afterImgPreload()',500);
  }
